...
## [v2.58.0](https://github.com/ruiramos/cli/compare/v2.57.0...v2.58.0) - 2020-07-03
...
- Formatting [`56f170a`](https://github.com/ruiramos/cli/commit/56f170a936e92ebb47f8af25c08653f19c40a8db)
...
- Fix requests hanging when function not found [`#965`](https://github.com/ruiramos/cli/pull/965)
...
- Docs: Use better word [`b7a28d0`](https://github.com/ruiramos/cli/commit/b7a28d026b04ec068c0cca24edad81593413ec9f)
...
- Fix typo in Netlify Functions section. [`#774`](https://github.com/ruiramos/cli/pull/774)
...
- Fix a reference bug [`4c27f4f`](https://github.com/ruiramos/cli/commit/4c27f4f877b48c2036a7da24057bfa728af45204)
...
- [api] Add support for not passing the data flag when it is not needed [`ef19863`](https://github.com/ruiramos/cli/commit/ef19863b92430ad38d496238cbb15705102bd84c)
...
## [v2.28.0](https://github.com/ruiramos/cli/compare/v2.27.0...v2.28.0) - 2020-01-09
...
## [v2.23.0](https://github.com/ruiramos/cli/compare/v2.22.0...v2.23.0) - 2019-12-05
...
- Refactor redirects to a seperate function [`e5c0481`](https://github.com/ruiramos/cli/commit/e5c0481e598ed760c1c73a2a7cd6ada3835688d3)
...
- Fix linting [`#555`](https://github.com/ruiramos/cli/pull/555)
...
- refactor: update status verbose flag [`#390`](https://github.com/ruiramos/cli/pull/390)
...
- Add missing postinstall script [`#380`](https://github.com/ruiramos/cli/pull/380)
...
- Update .travis.yml [`b31497d`](https://github.com/ruiramos/cli/commit/b31497ded58779a1daa4881c5754156fa20e035e)
...
- Travis: Remove branch constraint from deploy [`fca8133`](https://github.com/ruiramos/cli/commit/fca813339e18111b7711d0bc6392ad5b6af42f82)
...
## [v2.11.25](https://github.com/ruiramos/cli/compare/v2.11.24...v2.11.25) - 2019-07-17
...
- add chalk to netlify init output [`0b806bf`](https://github.com/ruiramos/cli/commit/0b806bfd72120fb105d54ff5b50dff03d8d265d2)
...
## [v2.11.13](https://github.com/ruiramos/cli/compare/v2.11.12...v2.11.13) - 2019-04-25
...
- fix netlify addons:delete bug if multiple addons exist [`f423a40`](https://github.com/ruiramos/cli/commit/f423a40c398ab7132c805db0a1e36a6695bddc85)
...
## [v2.9.1](https://github.com/ruiramos/cli/compare/v2.9.0...v2.9.1) - 2019-03-21
...
## [v2.7.2](https://github.com/ruiramos/cli/compare/v2.7.1...v2.7.2) - 2019-02-19
...
## [v2.6.6](https://github.com/ruiramos/cli/compare/v2.6.5...v2.6.6) - 2019-01-31
...
- Update js-client to fix rate limit handling [`#217`](https://github.com/ruiramos/cli/pull/217)
...
- Simplify command reference site [`#140`](https://github.com/ruiramos/cli/pull/140)
...
## [v2.0.0-beta.7](https://github.com/ruiramos/cli/compare/v2.0.0-beta.6...v2.0.0-beta.7) - 2018-09-24
...
## [v2.0.0-beta.3](https://github.com/ruiramos/cli/compare/v2.0.0-beta.2...v2.0.0-beta.3) - 2018-09-10
...
- updates beta release [`#101`](https://github.com/ruiramos/cli/pull/101)
- install base modules [`#100`](https://github.com/ruiramos/cli/pull/100)
- [WIP] Add use case instructions to docs [`#97`](https://github.com/ruiramos/cli/pull/97)

### Commits

- update no-repo flow [`9d20d77`](https://github.com/ruiramos/cli/commit/9d20d77327279fce40271b8e7de21156d2fd96a5)
- update reamde [`6f47a88`](https://github.com/ruiramos/cli/commit/6f47a8802a76a8fe5649e5ccdb58b63e77b80e31)
- update telemetry [`5f1cf55`](https://github.com/ruiramos/cli/commit/5f1cf55bf65ebe16a648244c49606a8cf1866b4a)

## [v2.0.0-alpha.7](https://github.com/ruiramos/cli/compare/v2.0.0-alpha.6...v2.0.0-alpha.7) - 2018-09-08

### Merged

- update token refs [`#99`](https://github.com/ruiramos/cli/pull/99)
- Update global config [`#96`](https://github.com/ruiramos/cli/pull/96)
- update main readme [`#95`](https://github.com/ruiramos/cli/pull/95)
- Update docs [`#94`](https://github.com/ruiramos/cli/pull/94)
- Automatically use git remote URL to `netlify link` sites [`#92`](https://github.com/ruiramos/cli/pull/92)
- improve header output [`#93`](https://github.com/ruiramos/cli/pull/93)
- Update docs site [`#91`](https://github.com/ruiramos/cli/pull/91)
- Use an alternate open browser lib [`#89`](https://github.com/ruiramos/cli/pull/89)
- Improve watch copy [`#88`](https://github.com/ruiramos/cli/pull/88)
- Add draft deploys [`#87`](https://github.com/ruiramos/cli/pull/87)
...
- move site to site folder [`57b474f`](https://github.com/ruiramos/cli/commit/57b474f124e52b6e3910011188793b0d8577245e)
- move UI to site [`18487af`](https://github.com/ruiramos/cli/commit/18487affc9a6ae5a6840e47fa899ebd448d14a91)
- extract and share link prompt [`d07c14c`](https://github.com/ruiramos/cli/commit/d07c14c03c5dcc6e122d058e11c8c6a3d2f4f21f)

## [v2.0.0-alpha.6](https://github.com/ruiramos/cli/compare/v2.0.0-alpha.5...v2.0.0-alpha.6) - 2018-08-30

### Merged

- Deploy feedback [`#86`](https://github.com/ruiramos/cli/pull/86)
- Incorporate some flag design to the deploy command [`#85`](https://github.com/ruiramos/cli/pull/85)
- Set up our new client id [`#71`](https://github.com/ruiramos/cli/pull/71)
- Fix Copy [`#64`](https://github.com/ruiramos/cli/pull/64)
- Create Github deploy notifications on init [`#63`](https://github.com/ruiramos/cli/pull/63)
...
- First pass at deploy progress [`337a0e9`](https://github.com/ruiramos/cli/commit/337a0e92439e628c3c01e77972ce8052923e3f8f)
- Hooks work [`e41bcc7`](https://github.com/ruiramos/cli/commit/e41bcc76e6e5ca73a8818a7b0bbccd0c6c03532a)
- update edit link [`4f4d256`](https://github.com/ruiramos/cli/commit/4f4d25602ccd2ea7c238f6ca202ae681a17756c8)

## [v2.0.0-alpha.5](https://github.com/ruiramos/cli/compare/v2.0.0-alpha.4...v2.0.0-alpha.5) - 2018-08-28

### Merged

- Upload netlify TOML when deploying [`#61`](https://github.com/ruiramos/cli/pull/61)
- Add update notifier [`#60`](https://github.com/ruiramos/cli/pull/60)
- Fix badge links [`#59`](https://github.com/ruiramos/cli/pull/59)
- 2.0.0 Release [`#51`](https://github.com/ruiramos/cli/pull/51)
- Fix lint [`#50`](https://github.com/ruiramos/cli/pull/50)
- [WIP] Update docs [`#99`](https://github.com/ruiramos/cli/pull/99)
- Use netlify.toml info when linking [`#98`](https://github.com/ruiramos/cli/pull/98)
- Watch on init, and remove from sites commands [`#97`](https://github.com/ruiramos/cli/pull/97)
- Improve file filtering [`#95`](https://github.com/ruiramos/cli/pull/95)
- Remove unneeded quotes on link [`#94`](https://github.com/ruiramos/cli/pull/94)
- Document base class and reorganize [`#92`](https://github.com/ruiramos/cli/pull/92)
- Readme tweaks [`#91`](https://github.com/ruiramos/cli/pull/91)
- s/http/https [`#90`](https://github.com/ruiramos/cli/pull/90)
- Fix readme name hack [`#89`](https://github.com/ruiramos/cli/pull/89)
- Appveyor [`#49`](https://github.com/ruiramos/cli/pull/49)
...
- update docs [`821c9ba`](https://github.com/ruiramos/cli/commit/821c9bace31a7738b40976afdce89201712f8829)
- add site [`947767c`](https://github.com/ruiramos/cli/commit/947767cd16e186fccdd9a362dc28a8d1250194f4)
- add doc gen script (will move elsewhere) [`2028b53`](https://github.com/ruiramos/cli/commit/2028b53d4e5bedc09c2471959de2f0c6e503a1f2)

## [v2.0.0-alpha.4](https://github.com/ruiramos/cli/compare/v2.0.0-alpha.3...v2.0.0-alpha.4) - 2018-08-22

## [v2.0.0-alpha.3](https://github.com/ruiramos/cli/compare/v2.0.0-alpha.2...v2.0.0-alpha.3) - 2018-08-22

### Merged

- Fix function deploys [`#48`](https://github.com/ruiramos/cli/pull/48)
- Init GitHub [`#87`](https://github.com/ruiramos/cli/pull/87)
- Add Init function [`#47`](https://github.com/ruiramos/cli/pull/47)
- [WIP] Add `addons` commands [`#85`](https://github.com/ruiramos/cli/pull/85)
- Initial sites:create command [`#72`](https://github.com/ruiramos/cli/pull/72)

### Commits

- GitHub init work [`80c2f0a`](https://github.com/ruiramos/cli/commit/80c2f0af0b03d13f3587dd9602e36eedb5182977)
- add addon commands [`73b2d96`](https://github.com/ruiramos/cli/commit/73b2d96daa7f7ed9154a24fa116fbdac40246113)
- Checking in progress [`ce88ad6`](https://github.com/ruiramos/cli/commit/ce88ad6ff7f6dfbed6cdeb87f25491b2ad7581b2)

## [v2.0.0-alpha.2](https://github.com/ruiramos/cli/compare/v2.0.0-alpha.1...v2.0.0-alpha.2) - 2018-08-17

### Commits

- Fix prod dependencies [`6a462dc`](https://github.com/ruiramos/cli/commit/6a462dced612e274629483123a1ab1e604190ad3)

## [v2.0.0-alpha.1](https://github.com/ruiramos/cli/compare/v1.2.3...v2.0.0-alpha.1) - 2018-08-16

### Merged

- update open cmd [`#81`](https://github.com/ruiramos/cli/pull/81)
- Fix function uploads [`#70`](https://github.com/ruiramos/cli/pull/70)
- Update status command [`#69`](https://github.com/ruiramos/cli/pull/69)
- Remove help plugin [`#68`](https://github.com/ruiramos/cli/pull/68)
- Function deploys [`#62`](https://github.com/ruiramos/cli/pull/62)
- Add unlink command [`#67`](https://github.com/ruiramos/cli/pull/67)
- Fix api calls [`#65`](https://github.com/ruiramos/cli/pull/65)
- Add inquirer prompts [`#45`](https://github.com/ruiramos/cli/pull/45)
- Swap deps [`#46`](https://github.com/ruiramos/cli/pull/46)
- Use open-api spec directly [`#44`](https://github.com/ruiramos/cli/pull/44)
- Deploy Command [`#37`](https://github.com/ruiramos/cli/pull/37)
- Add status command [`#38`](https://github.com/ruiramos/cli/pull/38)
- Add whoami command [`#36`](https://github.com/ruiramos/cli/pull/36)
- Init again [`#31`](https://github.com/ruiramos/cli/pull/31)
- Site config [`#27`](https://github.com/ruiramos/cli/pull/27)

### Commits

- Reset Repo [`b62819b`](https://github.com/ruiramos/cli/commit/b62819bc9e1c05c01ea8c284ce6e1c2586226aea)
- Use r2 API client using open-api derived methods [`080572f`](https://github.com/ruiramos/cli/commit/080572fdad2e7decd415c1002d3bb55f153bc198)
- Check in function deploy work [`48b7605`](https://github.com/ruiramos/cli/commit/48b76055061eecb6ee7ed9d2057e0580d3028095)

## v1.2.3 - 2018-07-10

### Merged

- Deploy command [`#26`](https://github.com/ruiramos/cli/pull/26)
- Fix a bunch of babel and Ava issues [`#25`](https://github.com/ruiramos/cli/pull/25)
- Add ava test harness [`#23`](https://github.com/ruiramos/cli/pull/23)
- Use new auth hook [`#22`](https://github.com/ruiramos/cli/pull/22)
- Only store the auth token [`#21`](https://github.com/ruiramos/cli/pull/21)
- Add a babel build step [`#19`](https://github.com/ruiramos/cli/pull/19)
- Env override [`#18`](https://github.com/ruiramos/cli/pull/18)
- Add login hook [`#16`](https://github.com/ruiramos/cli/pull/16)
- Promisify api client [`#15`](https://github.com/ruiramos/cli/pull/15)
- Add login [`#7`](https://github.com/ruiramos/cli/pull/7)
- Scaffold cmds [`#6`](https://github.com/ruiramos/cli/pull/6)
- Add prettierrc file [`#5`](https://github.com/ruiramos/cli/pull/5)
- remove java codegen deps [`#4`](https://github.com/ruiramos/cli/pull/4)
- Use openapi client module [`#2`](https://github.com/ruiramos/cli/pull/2)
- Fix authentication prompt typo [`#41`](https://github.com/ruiramos/cli/pull/41)
- deprecatin' [`#38`](https://github.com/ruiramos/cli/pull/38)
- Add missing project management files. [`#22`](https://github.com/ruiramos/cli/pull/22)
- Add "env" command [`#18`](https://github.com/ruiramos/cli/pull/18)
- Permalink is displayed after deployment (along with the alias URL). [`#5`](https://github.com/ruiramos/cli/pull/5)

### Fixed

- Fixes #3 - Content-Length was not always correct in post requests [`#3`](https://github.com/ruiramos/cli/issues/3)

### Commits

- init commit [`041da26`](https://github.com/ruiramos/cli/commit/041da26dd050b4f51809040ba8cc99e61ba20d10)
- Remove troublesome lock files [`2a43998`](https://github.com/ruiramos/cli/commit/2a43998fa616b973779a7a2e3f1534eef73c09e4)
- Fix dependencies with shrinkwrap and yarn.lock [`f4f5dc3`](https://github.com/ruiramos/cli/commit/f4f5dc3de1fa1f33508e4c667dca3d1a7aea7b34)
